      ...
      <div className="w-full flex flex-col lg:flex-row bg-white rounded-2xl shadow-lg overflow-hidden p-5">
        ...
        <div className="p-3 sm:p-6 lg:p-3 xl:p-6 lg:w-[55%]  w-full">
          ...
          <div className="flex items-center gap-3 lg:gap-2 xl:gap-3">
            ...
            <button className=" text-base lg:text-sm xl:text-base w-max px-4 py-2 text-gray-800 hover:bg-gray-200 transition rounded-2xl border border-gray-300">Details</button>
            <button className=" text-base lg:text-sm xl:text-base w-max px-4 py-2 bg-[#6f4fee] text-white rounded-2xl hover:bg-blue-600 transition">Place a Bid</button>
          </div>
        </div>
      </div>
    </div>
