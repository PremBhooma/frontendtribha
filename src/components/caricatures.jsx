      ...
      <div className="w-full p-5">
        <div className="w-full flex bg-white rounded-xl shadow-lg overflow-hidden p-5">
          <div className="relative">
            <Skeleton className="w-[20rem] h-[20rem] rounded-xl" />
          </div>
      ...
      <div className="w-full flex flex-col md:flex-row bg-white rounded-xl shadow-lg overflow-hidden p-5">
        ...
        <div className="p-6 md:w-[60%] w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-1 text-gray-800 hover:bg-gray-200 transition rounded-2xl border border-gray-300">Details</button>
            <button className="px-4 py-1 bg-blue-500 text-white rounded-2xl hover:bg-blue-600 transition">Place a Bid</button>
          </div>
        </div>
      </div>
    </div>
